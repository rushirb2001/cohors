...
cohors is open source (MIT) and built in public. Issues, ideas, and PRs are welcome.
...
cargo build -p cohors-core --target wasm32-unknown-unknown   # core must stay WASM-safe
```
